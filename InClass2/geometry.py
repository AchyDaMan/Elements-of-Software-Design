...
class Sphere():
  ...
  # returns a floating point number
    def area(self):
        self.area_value = math.pi * 4 * (self.radius ** 2)
        return self.area_value

  # compute volume of a Sphere
  # returns a floating point number
    def volume(self):
        self.volume_value = math.pi * (4/3) * (self.radius ** 3)
...
class Cube():
  ...
  # and x-z planes.
    def __init__(self, x = 0.0, y = 0.0, z = 0.0, side = 1):
        self.x = float(x)
        self.y = float(y)
        self.z = float(z)
        self.center = Point(self.x, self.y, self.z)
  ...
  # returns a floating point number
    def area(self):
        self.area_value = 6 * (self.side ** 2)
        return self.area_value

  # compute volume of a Cube
  # returns a floating point number
    def volume(self):
        self.volume_value = self.side ** 3
        return self.volume_value
